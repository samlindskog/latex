...
\begin{example}
	...
	\end{IEEEproof}
\end{example}
\begin{definition}[Supercritical pitchfork bifurcation]
	...
	\end{equation*}
\end{definition}
\begin{definition}[Subcritical pitchfork bifurcation]
...
\end{definition}
\begin{definition}[Attracting point]
...
\end{definition}
\begin{definition}[Liapunov stable]
...
\end{definition}
\begin{definition}[Stable/unstable]
...
\end{definition}
\begin{definition}[Star and degenerate node]
...
\end{definition}
\begin{definition}[Reversable system]
